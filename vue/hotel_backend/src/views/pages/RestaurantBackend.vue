...
//import會用到的東西
    ...
    import RestaurantBookingModal from "@/components/RestaurantBookingModal.vue";
    // import ChooseRows from "@/components/ChooseRows.vue";
...
/* 暫時的格式 */
    ...
    .table-primary {
    background-color:	#FFEEDD; /* 將表格背景色設置為白色 */
}
