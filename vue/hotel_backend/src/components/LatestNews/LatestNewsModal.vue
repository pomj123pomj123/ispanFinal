  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="myTable"><!-- 用v-model綁定各項input -->
            <!-- <tr>
                <td>館別 : </td>
            ...
            <tr>
                <td>標題 : </td>
                <td><input class="form-control" type="text" v-model="formData.title" ></td>
            </tr>
            <tr>
                <td>起始日 </td>
                <td><input class="form-control" type="date" v-model="formData.startDate"></td>
            </tr>
            <tr>
                <td>結束日 </td>
                <td><input class="form-control" type="date"  v-model="formData.endDate"> 
                    <button type="button" class="btn btn-light  btn-sm" @click="forever">永久<i class="bi bi-check2-circle"></i></button> 
            ...
            <tr>
                <td>內文 : </td>
                <td><textarea class="form-control" v-model="formData.content" style="width: 100%; height: 150px;"></textarea></td>
            </tr>
            <!-- <tr>
                <td>圖片 : </td>
            ...
            <tr>
                <td>類型 : </td>
                <td><select class="form-select" v-model="formData.type">
