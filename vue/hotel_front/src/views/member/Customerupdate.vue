<template>
  <div class="container">
    ...
    <div>
      ...
      <div class="cardbackground">
        <div>
          <img src="http://192.168.31.160:8080/member/pages/1" alt="會員卡" class="photo-img" style="z-index: 1;" />
  ...
  <input v-if="field.type !== 'textarea' && field.type !== 'checkbox'&& field.type !== 'select'" :type="field.type" v-model="field.value" :required="field.required"
    :disabled="field.disabled" />
  <textarea v-else-if="field.type === 'textarea'" :rows="4" :cols="field.cols" v-model="field.value" :required="field.required"
    :disabled="field.disabled" style="width: 50%; max-width: 50%;max-height: 200px;margin:0% 0% 0% 25%;"></textarea>
  <!-- 樣式 checkbox-->
  <input v-else-if="field.type === 'checkbox'" type="checkbox" :id="field.id" v-model="field.value" :class="field.class" style="width: 20px; height: 20px; background-color:white; border: 1px solid #000000; border-radius: 3px; cursor: pointer;">
 <!-- 性別 option-->
