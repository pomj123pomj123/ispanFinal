...
import com.ispan.hotel.util.SystemConstant;
...
public class BookingEcpayServiceYTH {
	...
	public AioCheckOutALL createAioCheckOutALL(String json) {
		...
		acoa.setReturnURL(SystemConstant.hostURL+":8080/booking/book/paymentend");
		acoa.setOrderResultURL(SystemConstant.hostURL+":8080/booking/book/paymentend");
		acoa.setNeedExtraPaidInfo("N");
		acoa.setClientBackURL(SystemConstant.vueURL+"/bookingPages/bookingFinal");
